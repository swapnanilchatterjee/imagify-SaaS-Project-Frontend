      ...
      <div>
        {user ? (
          <div className='flex items-center gap-2 sm:gap-3'>
            <button onClick={()=>nvigate('/buy')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:[y-3 rounded-full hover:scale-105 transition-all duration-700'>
          ...
          <div className="flex items-center gap-2 sm:gap-5">
            <p onClick={()=>nvigate('/buy')} className='cursor-pointer'>Pricing</p>
